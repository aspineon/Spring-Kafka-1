...
import com.github.springkafka.springkafka.model.FlightReservation;
...
public class ConsumerOperation {
    ...
    public void listen(@Payload FlightReservation message, @Header(KafkaHeaders.RECEIVED_PARTITION_ID) int partition) throws IOException {
        logger.info("Consuming message - {} , patition id - {} ", message, partition);
        logger.info("Consuming message and after deserialization - {} ", message.toString());
    }
}
